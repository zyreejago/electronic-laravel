                    ...
                    <div class="card-body p-4">
                        @if($booking->technician)
                            ...
                            <div class="mb-3">
                                <div class="mb-2">
                                    <span class="text-muted">Email:</span>
                                    <span class="fw-bold ms-2">{{ $booking->technician->user->email }}</span>
                                </div>
                                <div>
                                    <span class="text-muted">Phone:</span>
                            ...
                            <div class="alert border-0 p-3" style="background: rgba(28, 200, 138, 0.1); color: #13855c; border-left: 4px solid #1cc88a;">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <p class="mb-0">This technician has been assigned to handle this service booking.</p>
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted mb-4">This booking is waiting for a technician to be assigned.</p>
                                @if($booking->status === 'pending')
                                    <button type="button" class="btn btn-success btn-lg w-100" data-bs-toggle="modal" data-bs-target="#assignTechnicianModal">
