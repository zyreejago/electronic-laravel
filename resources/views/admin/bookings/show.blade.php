                ...
                <div class="card border-0 shadow rounded-4 overflow-hidden h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h6 class="fw-bold mb-0">Technician Information</h6>
                                <small class="text-muted">Assigned technician details</small>
                            </div>
                        </div>
                        <div class="ps-5 mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <span class="fw-bold ms-2">{{ $booking->technician->user->name }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-muted">Specialization:</span>
                                            <span class="fw-bold ms-2">{{ $booking->technician->specialization ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                            <span class="text-muted">Phone:</span>
                                            <span class="fw-bold ms-2">{{ $booking->technician->user->phone_number ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                            ...
                            @else
                                <div class="alert alert-warning border-0 p-3" style="background: rgba(255, 193, 7, 0.1); color: #856404;">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    Teknisi belum di-assign untuk booking ini.
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="ps-5 mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <span class="fw-bold ms-2">Rp {{ number_format($estimatedCost, 0, ',', '.') }}</span>
                                    </div>
                                    @if($inventoryCost > 0)
                                    <div class="mb-2">
                                        <span class="text-muted">Inventory Cost:</span>
                                        <span class="fw-bold ms-2">Rp {{ number_format($inventoryCost, 0, ',', '.') }}</span>
                                    </div>
                                    @endif
                                    @if($serviceComponentsCost > 0)
                                    <div class="mb-2">
                                        <span class="text-muted">Service Components:</span>
                                        <span class="fw-bold ms-2">Rp {{ number_format($serviceComponentsCost, 0, ',', '.') }}</span>
                                    </div>
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    @if($deliveryFee > 0)
                                    <div class="mb-2">
                                        <span class="text-muted">{{ ucfirst($booking->service_type) }} Fee:</span>
                                        <span class="fw-bold ms-2">Rp {{ number_format($deliveryFee, 0, ',', '.') }}</span>
                                    </div>
                                    @endif
                                    @if($emergencyFee > 0)
                                    <div class="mb-2">
                                        <span class="text-muted">Emergency Fee:</span>
                                        <span class="fw-bold ms-2">Rp {{ number_format($emergencyFee, 0, ',', '.') }}</span>
                                    </div>
                                    @endif
                                    @if($loyaltyDiscount > 0)
                                    <div class="mb-2">
                                        <span class="text-muted">Loyalty Points Discount:</span>
                                        <span class="fw-bold ms-2 text-success">- Rp {{ number_format($loyaltyDiscount, 0, ',', '.') }}</span>
                                    </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="mt-3 p-3 bg-primary bg-opacity-10 rounded-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-bold mb-0 text-primary">Total Price:</span>
                                    <span class="h5 fw-bold mb-0 text-primary">Rp {{ number_format($totalPrice, 0, ',', '.') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-2">
                                <small class="text-info">
                                    ...
                                    Customer menggunakan {{ $booking->loyalty_points_used }} loyalty points untuk mendapat diskon Rp {{ number_format($loyaltyDiscount, 0, ',', '.') }}
                                </small>
                            </div>
                            @endif
                        </div>
