        ...
        <div class="col-md-8">
            <div class="card border-0 shadow rounded-4 overflow-hidden">
                            ...
                            <div class="col-md-12">
                                <div class="mb-4">
                                    <label for="phone_number" class="form-label fw-bold text-primary">
                                        <i class="fas fa-phone me-2"></i>{{ __('Phone Number (WhatsApp)') }}
                                    </label>
                                    ...
                                    @enderror
                                    <div class="form-text">
                                        <i class="fab fa-whatsapp text-success me-1"></i>We'll use this number for service updates via WhatsApp
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer bg-light p-4 text-center">
                    <p class="mb-0">Already have an account? <a href="{{ route('login') }}" class="fw-bold text-decoration-none">Login here</a></p>
                </div>
            </div>
        </div>
    </div>
